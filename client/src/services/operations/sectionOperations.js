...
import { setAllSectionData, setSectionData, setSubSectionData } from "../../features/Courses/sectionSlice";
...
export function getSection(id){
  return async(dispatch)=>{
    try {
      const response=await apiConnector('GET',GET_SECTION_API,{id});
      // console.log("get Section Response => ",response)
      dispatch(setSectionData(response.data.data))
      if (response.data.success) {
        dispatch(setSuccess(true))
      }else{
