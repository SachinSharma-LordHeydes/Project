...
async function verifyEsewaPayment(encodedData) {
  try {
    ...
    //   `total_amount=${Number(decodedData.total_amount).toFixed(2)}`,
...
//     // Validate signed_field_names
//     if (decodedData.signed_field_names !== 'total_amount,transaction_uuid,product_code') {
//       throw new Error("Invalid signed_field_names");
//     }
...
//     const reqOptions = {
//       url: `${process.env.ESEWA_GATEWAY_URL}/api/epay/transaction/status/?product_code=${process.env.ESEWA_PRODUCT_CODE}&total_amount=${Number(decodedData.total_amount).toFixed(2)}&transaction_uuid=${decodedData.transaction_uuid}`,
//       method: "GET",
//       headers: {
//         Accept: "application/json",
//         "Content-Type": "application/json"
